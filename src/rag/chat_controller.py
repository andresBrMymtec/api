...
llm: OpenAiModels = OpenAiModels(model_ai='gpt-4.1-mini', temp=0)
...
4. SI hay ambigüedad (por ejemplo, no se especifica si el procedimiento es para exportación o importación), siempre pedir aclaración del usuario ANTES de responder.
